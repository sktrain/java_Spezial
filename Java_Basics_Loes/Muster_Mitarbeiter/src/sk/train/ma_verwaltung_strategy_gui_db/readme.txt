...
- Factory für Gehaltsmodelle ist vorhanden (alternativ Factory-Methode im Interface Gehaltsmodell
- Klassen haben Standardmethoden (toString, equals, hashcode) überschrieben 


- ergänzt um Gui via Swing JTable 
- ergänzt um rudimentären DB-Zugriff via JDBC
