...
public class FixGehaltMitarbeiter extends Mitarbeiter{
	...
	public String toString() {
		return "FixGehaltMitarbeiter [gehalt=" + gehalt + ", getVorname()=" + getVorname() + ", getGeschlecht()="
				+ getGeschlecht() + ", getNachname()=" + getNachname() + ", getPersnr()=" + getPersnr()
				+ ", getGebdatum()=" + getGebdatum() + ", getEinstdatum()=" + getEinstdatum() + "]";
	}
